...
export default function HomeHeader() {
  ...
  return (
    <>
      ...
      <header
        className={`fixed top-0 left-0 right-0 w-full z-[100] transition-all duration-300 ${isScrolled ? 'py-3 shadow-lg' : 'py-4'}`}
      ...
      >
        ...
        <div className="w-full px-4 md:max-w-7xl md:mx-auto md:px-6 flex justify-between items-center">
          {/* Logo */}
